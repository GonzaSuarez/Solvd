...
((SELECT idplan FROM mydb.plan WHERE plan_name= "Easter Discount"),(SELECT idTravelCompany FROM mydb.Travel_Company WHERE company_name = "Travel Quequen")),
...
((SELECT idplan FROM mydb.plan WHERE plan_name= "Christmas Discount"),(SELECT idTravelCompany FROM mydb.Travel_Company WHERE company_name = "Travel Miami")),
...
((SELECT idplan FROM mydb.plan WHERE plan_name= "Thanks Giving Discount"),(SELECT idTravelCompany FROM mydb.Travel_Company WHERE company_name = "Travel L"));
